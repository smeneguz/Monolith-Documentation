...
\begin{center}
	...
	\begin{tabular}{|c|c|c|}
		...
		\hline  \emph{Verificatore}  & 33(-1) & 480 \\
		\hline
		\textbf{Totale consuntivo} & 140 & 2998 \\
		\hline
		\textbf{Totale preventivo} & 140 & 2997 \\
		\hline
		\textbf{Totale differenza} & 0 & +1 \\
		\hline
	\end{tabular}
...
Di conseguenza, per questa fase, sono emerse differenze tra il consuntivo e il preventivo per una perdita di: +1€.

\subsubsection{Preventivo a finire}
Da quanto si evince dal consuntivo corrente per questo periodo, il team ha superato il preventivo
di 1€. Considerando i 15€ risparmiati nella fase precedente il bilancio è in positivo di 14€. 
...
\begin{center}
	...
	\begin{tabular}{|c|c|c|}
		...
		\hline  \emph{Progettista}  & 70(+2) & 1584 \\
		\hline  \emph{Verificatore}  & 36 & 540 \\
		\hline
		\textbf{Totale consuntivo} & 137 & 2884 \\
		\hline
		\textbf{Totale preventivo} & 135 & 2830 \\
		\hline
		\textbf{Totale differenza} & +2 & +54 \\
		\hline
	\end{tabular}
...
Di conseguenza, per questa fase, sono emerse differenze tra il consuntivo e il preventivo per una perdita di: +54€.

\subsubsection{Preventivo a finire}
Da quanto si evince dal consuntivo corrente per questo periodo, il team ha superato il preventivo
di 54€. Considerando le fasi precedenti, il bilancio risulta essere in negativo di 40€. Obelix si impegna prendendosi a carico le spese che eccedono dal preventivo. 
...
\subsubsection{Preventivo a finire}
Da quanto si evince dal consuntivo corrente per questo periodo, il team ha superato il preventivo
di 15€. Considerando le fasi precedenti, il bilancio risulta essere in negativo di 55€. Obelix si impegna prendendosi a carico le spese che eccedono dal preventivo. 
...
\begin{center}
	...
	\begin{tabular}{|c|c|c|}
		...
		\hline
	\end{tabular}
	\captionof{table}{Ore totali di investimento - differenza preventivo/consuntivo in fase di Validazione}
...
\subsubsection{Preventivo a finire}
Da quanto si evince dal consuntivo corrente per questo periodo, il team ha superato il preventivo
di 39€. Considerando le fasi precedenti, il bilancio risulta essere in negativo di 94€. Obelix si impegna prendendosi a carico le spese che eccedono dal preventivo. 
...
\begin{center}
	...
	\begin{tabular} {|c|c|c|c|c|c|c|c|}
		...
		& \textbf{Re} & \textbf{Am} & \textbf{An} & \textbf{Pj} & \textbf{Pr} & \textbf{Ve} & \\
		\hline
		Emanuele Crespan &20 &0 &0 &34 &21 &32 &107\\
		\hline
		...
		\hline
	\end{tabular}
	\captionof{table}{Ore per componente, Consuntivo finale}
\end{center}
...
\begin{center}
	...
	\begin{tabular}{|c|c|c|}
		...
		\hline
		\textbf{Rendicontato} &12287  & 12381  \\
		\hline
	\end{tabular}
	\captionof{table}{Consuntivo economico conclusivo}
